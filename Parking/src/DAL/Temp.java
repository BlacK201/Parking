...
import DBUtil.SQLUtil;
		...
		public static String getCharge(){
			...
			chargeMap.put(20, 0);//前20分钟免费
			chargeMap.put(21, 5);//大于20分钟5元
			chargeMap.put(60, 5);//大于20分钟小于60分钟5元
			chargeMap.put(61, 7);//超过一小时，每小时7元
			String jsonString = JSONObject.toJSONString(chargeMap);
			return jsonString;
		}
